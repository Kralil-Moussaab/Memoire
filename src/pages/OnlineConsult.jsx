...
//       {!showDoctorList && selectedDoctor && !showPayment && (
//         <button
//           onClick={handleEndChat}
//           className="absolute top-24 right-4 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors"
//         >
//           End Chat
//         </button>
//       )}
